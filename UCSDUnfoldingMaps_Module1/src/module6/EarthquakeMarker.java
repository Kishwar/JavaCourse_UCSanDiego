...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker marker) {
		//getMagnitude returns float.. it primitive variable so can't run compareTo on it
		//If it were object, like string.. then do as following comment
		//return ((this.getTitle()).compareTo(marker.getTitle()))
		//but for permitive varilable.. little manual job as following
